...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='medcity', help='folder | cifar10 | mnist | medcity')
        ...
        self.parser.add_argument('--isize', type=int, default=1024, help='input image size.')
